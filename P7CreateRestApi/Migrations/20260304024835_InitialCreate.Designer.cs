...
namespace FindexiumAPI.Migrations
{
    ...
    [Migration("20260304024835_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.BidList", b =>
                {
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.CurvePoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.RuleName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.Trade", b =>
                {
            ...
            modelBuilder.Entity("FindexiumAPI.Domain.User", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FindexiumAPI.Domain.User", null)
                        .WithMany()
